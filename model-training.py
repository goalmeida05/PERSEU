...
def calc_properties(file_path, label: int):
    ...
    matrix = np.zeros((list_len, 831), dtype=object) 
...
########################################################### MODEL TRAINING ####################################################################
##############################################################################################################################################
def training_model(training_matrix_path):
...
positives_path = '' #your positives FASTA path  file
negatives_path = '' #your negatives FASTA path  file
training_matrix_path = '' #input the training matrix CSV file


training_model(training_matrix_path)
